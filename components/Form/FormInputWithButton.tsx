        ...
        <div className="relative">
          <input
            ...
            className={
              ...
              'bg-light dark:bg-dark text-dark dark:text-light disabled:opacity-30 ' +
              (!!appendIcon ? 'pr-18 ' : '') +
              (inputClassName || '')
            }
            onBlur={() => onBlur?.()}
          ...
          <div
            className={
              ...
              "border border-slate-400 dark:border-slate-600 bg-light dark:bg-dark text-dark dark:text-light duration-300 " +
          ...
          >
            <i className={buttonIcon || "fa-solid fa-arrow-right"} />
          </div>
        </div>
